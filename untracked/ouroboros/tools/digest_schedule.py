...
def get_tools() -> List[ToolEntry]:
    return [
        ToolEntry(name="digest_schedule_set", schema=_SCHEMA_SET, handler=_digest_schedule_set),
        ToolEntry(name="digest_schedule_status", schema=_SCHEMA_STATUS, handler=_digest_schedule_status),
        ToolEntry(name="digest_schedule_disable", schema=_SCHEMA_DISABLE, handler=_digest_schedule_disable),
        ToolEntry(name="digest_run_now", schema=_SCHEMA_RUN_NOW, handler=_digest_run_now),
    ]
