    ...
    for raw_alias, raw_record in targets_raw.items():
        ...
        try:
            record = _normalize_target_record(
                ...
                panel_username=raw_record.get("panel_username", ""),
                panel_password=raw_record.get("panel_password", ""),
...
def _normalize_target_record(
    *,
    ...
    return {
        ...
        "panel_username": _normalize_metadata_string(panel_username),
...
def _public_target_view(record: Dict[str, Any]) -> Dict[str, Any]:
    return {
        ...
        "has_panel_credentials": bool(record.get("panel_username") and record.get("panel_password")),
        "panel_username": record.get("panel_username", ""),
...
def _ssh_target_update(
    ...
    record = _normalize_target_record(
        ...
        panel_username=panel_username or current.get("panel_username", ""),
        panel_password=panel_password or current.get("panel_password", ""),
    ...
    return [
        _tool_entry(
            ...
            "Register or replace an SSH target in the persistent registry.",
            {
                ...
                "panel_username": {"type": "string"},
                "panel_password": {"type": "string"},
