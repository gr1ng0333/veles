    ...
    *,
    ...
    if model_transport(active_model) != "copilot":
        ...
        warn = (
            ...
            f"(лимит {max_rounds}). "
            "Прямо сейчас: сохрани scratchpad (update_scratchpad), допиши что важно, "
    ...
    warn = (
        ...
        "Доведи текущий шаг до стабильной точки: сохрани scratchpad, "
        "зафиксируй промежуточные результаты. "
