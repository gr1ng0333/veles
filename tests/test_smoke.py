...
EXPECTED_TOOLS = [
    ...
    "time_status",
    "research_report",
    "project_init", "project_github_create", "project_branch_checkout", "project_branch_list", "project_branch_get", "project_branch_delete", "project_branch_rename", "project_issue_list", "project_issue_get", "project_issue_create", "project_issue_comment", "project_issue_update", "project_issue_close", "project_issue_reopen", "project_issue_label_add", "project_issue_label_remove", "project_issue_assign", "project_issue_unassign", "project_pr_list", "project_pr_get", "project_pr_comment", "project_pr_merge", "project_pr_create", "project_pr_close", "project_pr_reopen", "project_pr_review_list", "project_pr_review_submit", "project_file_read", "project_file_write", "project_commit", "project_push", "project_status", "project_server_register", "project_server_list", "project_server_get", "project_server_remove", "project_server_run", "project_server_sync", "project_deploy_recipe", "project_deploy_apply", "project_service_render_unit", "project_service_control",
]
