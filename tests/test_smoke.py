...
EXPECTED_TOOLS = [
    ...
    "remote_list_dir", "remote_read_file", "remote_stat", "remote_mkdir", "remote_write_file", "remote_find", "remote_grep", "remote_project_discover", "remote_project_fetch", "remote_investigate_project", "remote_command_exec", "remote_capabilities_overview",
    # Plan management
